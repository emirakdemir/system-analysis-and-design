...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Admin silindi';
   }else{
      $warning_msg[] = 'Admin daha önce silindi!';
   }
...
<section class="grid">
   ...
   <div class="box" style="text-align: center;">
      <p>yeni admin yarat</p>
      <a href="register.php" class="btn">şimdi kayıt ol</a>
   </div>
   ...
   <div class="box" <?php if( $fetch_admins['name'] == 'admin'){ echo 'style="display:none;"'; } ?>>
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="delete admins" onclick="return confirm('bu admini sil?');" name="delete" class="btn">
      </form>
   </div>
   <?php
      }
